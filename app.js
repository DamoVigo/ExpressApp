...
var countriesDBRouter = require('./routes/countriesDB');
var usersAddRouter = require('./routes/usersAdd');
...
app.use('/usersAdd', usersAddRouter);
app.use('/countries', countriesRouter)
app.use('/countriesDB', countriesDBRouter)
